...
public class GenericSalesforceRuleDefinition implements RulesDefinition {
  ...
  public void define(Context context) {
    ...
    NewRepository repository =
        context
            .createRepository(SalesforcePlugin.REPOSITORY_KEY, SalesforcePlugin.LANGUAGE_KEY)
            .setName("Salesforce Analyzer");
    ...
    addRulesFromPmdRuleset(
        repository, "/org/sonar/salesforce/rulesets/apex/bestpractices.xml", RuleType.BUG);
    addRulesFromPmdRuleset(
        repository, "/org/sonar/salesforce/rulesets/apex/codestyle.xml", RuleType.CODE_SMELL);
    addRulesFromPmdRuleset(
        repository, "/org/sonar/salesforce/rulesets/apex/design.xml", RuleType.CODE_SMELL);
    addRulesFromPmdRuleset(
        repository, "/org/sonar/salesforce/rulesets/apex/errorprone.xml", RuleType.BUG);
    addRulesFromPmdRuleset(
        repository, "/org/sonar/salesforce/rulesets/apex/performance.xml", RuleType.BUG);
    addRulesFromPmdRuleset(
        repository, "/org/sonar/salesforce/rulesets/apex/security.xml", RuleType.VULNERABILITY);
    addRulesFromPmdRuleset(
        repository, "/org/sonar/salesforce/rulesets/apex/documentation.xml", RuleType.CODE_SMELL);
  ...
  public void addRulesFromPmdRuleset(
      NewRepository repository, String resourcePath, RuleType ruleType) {
